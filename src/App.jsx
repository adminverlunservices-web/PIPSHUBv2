    ...
    <>
      ...
      <main className="shell">
        <header className="topbar">
          ...
          <div className="top-actions"><span className="connection"><i /> Live gateway</span>{connected ? <><span className="login-button">Connected</span><a className="login-button" href="logout.php">Logout</a></> : <a className="login-button" href="deriv/login.php">Connect Deriv</a>}</div>
        </header>
        {children}
      </main>
    </>
